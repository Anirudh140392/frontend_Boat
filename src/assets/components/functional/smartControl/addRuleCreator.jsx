...
const normalizeFilters = (filters) => {
    ...
    if (platform === "Amazon") {
        return `https://react-api-script.onrender.com/boat/update-rule?rule_id=${ruleData.rule_id}&platform=${platform}`;
    } else if (platform === "BigBasket") {
        return `http://localhost:3000/update-rule?platform=${platform}&rule_id=${ruleData.rule_id}`;
    }
    return "";
};
